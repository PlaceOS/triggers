...
This crystal lang library holds the database models that support PlaceOS.
...
Make sure to write thorough tests and maintain a PLAN.md file to keep track of progress.
